...
| TM-002 | Elevation | An AI runner calls an approval endpoint and approves its own operation. | Protocol Version 3 exposes no approval method. | Approval API requires a separate principal and control channel; see [ADR-0001](adr/0001-separate-approval-principal.md). | Release blocker |
